...
class BaseType(object):
    ...
    def dereference(cls, reference):
        ...
        raise NotImplementedError(
            "`dereference` must be implemented by a subclass.")
    ...
    def instantiate(cls, argument, study, name):
        ...
        """
        raise NotImplementedError(
            "`instantiate` must be implemented by a subclass.")
    ...
    def normalize(cls, reference):
        ...
        """
        raise NotImplementedError(
            "`normalize` must be implemented by a subclass.")

    @classmethod
    def check_type(cls, argument):
        """Check that an instance of the bound type is of the correct type."""
        raise NotImplementedError(
            "`check_type` must be implemented by a subclass.")

    @classmethod
    def annotation(cls):
        raise NotImplementedError(
            "`annotation` must be implemented by a subclass.")
